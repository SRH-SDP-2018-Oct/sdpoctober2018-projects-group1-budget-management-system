...
public class DatabaseConnect {
	...
	public GenericObjectPool getConnectionPool() {
		...
		public String transactionsAdd = "INSERT INTO transactions (account_id,bank_id,category_id,transaction_name,transaction_type,transaction_amount,transaction_date,Transaction_time,merchant_name) VALUES (?,?,?,?,?,?,?,?,?)";
